...
import VaseMain from '@/assets/main_vases.jpg';
import Vase1 from '@/assets/single_leave.jpg';
import Vase2 from '@/assets/cactus.jpg';
import Vase3 from '@/assets/abstract_vase.jpg';
import Vase4 from '@/assets/3clay_vase.jpg';
import Vase5 from '@/assets/clay_vase.jpg';

export default function VasesSection() {
  ...
  return (
    <section ref={ref} className="w-full min-h-[65vh] md:min-h-screen flex flex-col items-center justify-center bg-white dark:bg-black px-2 md:px-8 md:py-10 relative overflow-hidden">
        ...
        <div className="flex flex-row w-full gap-4 mb-4">
          ...
          <div className="w-1/2 flex items-center justify-center">
            <div className="aspect-[3/4] w-full max-w-[180px] rounded-lg overflow-hidden shadow-lg mx-auto">
              <Image src={VaseMain} alt="Vase Main" className="object-cover w-full h-full" priority />
            </div>
          </div>
          {/* Text */}
          <div className="w-1/2 flex flex-col justify-center items-start pr-2">
            <h2 className="text-xl font-cinzel text-black dark:text-white mb-2 tracking-wider select-none transition-colors duration-300">VASES</h2>
            <p className="amiko-regular text-black dark:text-white text-xs sm:text-sm text-left select-none transition-colors duration-300">
              crafting functional art, we present each vase, meticulously sculpted from solid coquina rock, embraces biomorphic forms that delve into the realms of shape, texture, and color.
            </p>
          </div>
        </div>
        {/* Carousel grid */}
        <div className="flex flex-row gap-4 overflow-x-auto pb-2 snap-x snap-mandatory w-full px-2">
          {[Vase1, Vase2, Vase3, Vase4, Vase5, VaseMain].map((img, i) => (
            <div key={i} className="relative min-w-[160px] max-w-[180px] h-44 rounded-lg overflow-hidden flex-shrink-0 snap-center cursor-pointer hover:scale-105 transition duration-300">
              <Image src={img} alt={`Vase ${i}`} fill className="object-cover" />
              {i === 5 && (
      ...
      <div className="hidden md:flex relative flex-1 w-full flex-col md:flex-row items-stretch justify-center max-w-[1600px] mx-auto" style={{ minHeight: columnHeight }}>
        ...
        >
          <h2 className="text-3xl md:text-4xl font-cinzel text-black dark:text-white mb-4 tracking-wider select-none transition-colors duration-300">VASES</h2>
          ...
          <div className="grid grid-cols-3 gap-12 w-full h-[calc(100%-7rem)] items-stretch">
            <div className="relative w-full h-full min-h-[120px] cursor-pointer hover:scale-120 transition duration-300">
              <Image src={Vase1} alt="Vase 1" fill className="rounded-lg object-cover" />
            </div>
            <div className="relative w-full h-full min-h-[120px] cursor-pointer hover:scale-120 transition duration-300">
              <Image src={Vase2} alt="Vase 2" fill className="rounded-lg object-cover" />
            </div>
            <div className="relative w-full h-full min-h-[120px] cursor-pointer hover:scale-120 transition duration-300">
              <Image src={Vase3} alt="Vase 3" fill className="rounded-lg object-cover" />
            </div>
            <div className="relative w-full h-full min-h-[120px] cursor-pointer hover:scale-120 transition duration-300">
              <Image src={Vase4} alt="Vase 4" fill className="rounded-lg object-cover" />
            </div>
            <div className="relative w-full h-full min-h-[120px] cursor-pointer hover:scale-120 transition duration-300">
              <Image src={Vase5} alt="Vase 5" fill className="rounded-lg object-cover" />
            </div>
            {/* Last image with overlay */}
            <div className="relative w-full h-full min-h-[120px] group">
              <Image src={VaseMain} alt="Vase 6" fill className="rounded-lg object-cover brightness-50 transition duration-300" />
              <div className="absolute inset-0 flex items-center justify-center">
